...
enum {
    JP_CAPS, // Our custom tap dance key; add any other tap dance keys to this enum 
};
...
//      Ct_L     Win_L    Alt_L                                SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        ...
        TD(JP_CAPS),    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           DSK_R,
    ...
    [1] = LAYOUT(
      ...
      LED_TILDE, LED_1,  LED_2,   LED_3,   LED_4,    LED_5,   LED_6,   LED_7,   LED_8,   LED_9,   LED_0,   LED_MINS, LED_EQL,  KC_INS,         _______,
       ...
       _______, RGB_RMOD, RGB_VAD, RGB_MOD, RGB_SPI, _______,  _______, _______, _______, _______, _______, _______,         _______,          KC_BRID,
        ...
        _______, _______, _______,                             _______,                            KC_RALT, _______, SCRNSHT, KC_MPRV, KC_MSTP, KC_MNXT
    ),
  ...
  switch (keycode) {
     case RGB_TOG:
      if (record->event.pressed) {
        //Toggle between full RGB mode and only single keys
...
static void set_rgb_mods_on() {
        rgb_matrix_set_color(72, 255, 0, 0); //Right FN col
        rgb_matrix_set_color(75, 0, 0, 255);
        rgb_matrix_set_color(86, 0, 255, 0);
        rgb_matrix_set_color(82, 255, 255, 0);

        rgb_matrix_set_color(66, 255, 0, 255); //F12
...
qk_tap_dance_action_t tap_dance_actions[] = {
    [JP_CAPS] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, ql_finished, ql_reset)
};